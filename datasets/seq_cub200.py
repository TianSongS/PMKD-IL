...
class MyCUB200(Dataset):
    ...
    def __init__(self, root, train=True, transform=None,
        ...
        #         download(ln, filename=os.path.join(root, 'cub_200_2011.zip'), unzip=True, unzip_path=root, clean=True)
            print('Have download,load from /home/tiansongsong/sci/twf/data/cub200')
## /home/tiansongsong/sci/twf/data/cub200/test_data.npz
## /home/tiansongsong/sci/twf/data/cub200/train_data.npz
        data_file = np.load(os.path.join('/home/tiansongsong/sci/twf/data/cub200', 'train_data.npz' if train else 'test_data.npz'), allow_pickle=True)
